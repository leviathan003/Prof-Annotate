...
from src.config import shortcuts as SC
...
from src.core.annotation.undo import UndoStack
from src.ui.drawing.bbox_tool import BBoxTool
from src.ui.drawing.keypoint_tool import KeypointTool
from src.ui.drawing.segmentation_tool import SegmentationTool
from src.ui.overlays.bbox_overlay import (
    HANDLE_BC,
    HANDLE_BL,
    HANDLE_BR,
    HANDLE_ML,
...
from src.ui.overlays.diff_overlay import DiffOverlay
from src.ui.overlays.keypoint_overlay import KeypointOverlay
from src.ui.overlays.segmentation_overlay import SegmentationOverlay
from src.utils.image import load_image_rgb, numpy_to_qpixmap
...
class AnnotationCanvas(QFrame):
    ...
    def load_entry(
        ...
        from src.core.annotation.parser import parse_label_file
    ...
    def _ensure_loader(self) -> None:
        ...
        from src.utils.ui_scaling import form_factor
    ...
    def _refresh_kpt_cursor(self) -> None:
        if self._active_draw_mode != "kpts" or self._kpt_tool is None:
            return
        from src.ui.drawing.keypoint_tool import _build_dot_cursor
