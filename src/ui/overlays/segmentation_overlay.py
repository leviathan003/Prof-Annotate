...
from src.config.constants import POLYGON_CLOSE_RADIUS_PX
from src.core.annotation.models import SegmentationMask
from src.utils.color import segmentation_color, segmentation_fill_color
