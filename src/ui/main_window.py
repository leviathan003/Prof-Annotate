...
from src.core.annotation.models import ImageAnnotations, Modality
from src.core.dataset.loader import DatasetIndex, ImageEntry, load_dataset
from src.core.dataset.validator import (
    SCENARIO_EMPTY,
...
from src.core.dataset.yaml_handler import generate_yaml
from src.core.git.reader import find_repo_root, get_last_annotation_commit, is_git_repo
from src.core.recovery.autosave import clear_session, load_session, save_session
from src.ui.dialogs.autoannotate_prompt import AutoAnnotatePrompt
from src.ui.dialogs.dataset_wizard import DatasetWizard
from src.ui.dialogs.error_dialog import ErrorDialog
from src.ui.widgets.canvas import AnnotationCanvas
from src.ui.widgets.file_explorer import FileExplorer
from src.ui.widgets.json_editor import JsonEditor
from src.ui.widgets.modality_selector import ModalitySelector
from src.ui.widgets.prof_widget import ProfWidget
from src.ui.widgets.stats_panel import StatsPanel
from src.ui.widgets.status_bar import StatusBar
from src.ui.widgets.yaml_editor import YamlEditor
from src.utils.logger import setup_logging
from src.utils.ui_scaling import (
...
class _SingleAutoAnnotateWorker(QObject):
    ...
    def run(self) -> None:
        try:
            from src.core.inference.engine import InferenceEngine
            from src.core.inference.filter import filter_by_modality
            from src.core.inference.postprocess import postprocess
            from src.ui.dialogs.dataset_wizard import _reindex_keypoints_for_selection
            from src.utils.image import image_dimensions, load_image_rgb
...
class _ReshuffleWorker(QObject):
    ...
    def run(self) -> None:
        try:
            from src.core.dataset.validator import reshuffle_into_yolo_format
...
class _BulkAutoAnnotateWorker(QObject):
    ...
    def _execute(self) -> None:
        from src.core.annotation.models import ImageAnnotations
        from src.core.annotation.writer import write_label_file
        from src.core.inference.engine import InferenceEngine
        from src.core.inference.filter import filter_by_modality
        from src.core.inference.postprocess import postprocess
        from src.ui.dialogs.dataset_wizard import _reindex_keypoints_for_selection
        from src.utils.image import derive_label_path, image_dimensions, load_image_rgb
...
class MainWindow(QMainWindow):
    ...
    def _on_open_file(self) -> None:
        from src.utils.image import derive_label_path
    ...
    def _start_bulk_auto_annotate(self, root: Path) -> None:
        ...
        from src.core.dataset.yaml_handler import load_yaml as _load_yaml_for_kpts
    ...
    def _prompt_kpt_selection_for_fresh_dataset(self) -> None:
        from src.core.dataset.yaml_handler import load_yaml, save_yaml
        from src.ui.dialogs.kpt_selection_dialog import KptSelectionDialog
    ...
    def _ensure_kpt_config_for_root(self, root: Path, force: bool = False) -> bool:
        ...
        """
        from src.core.dataset.yaml_handler import generate_yaml, load_yaml, save_yaml
        from src.ui.dialogs.kpt_selection_dialog import KptSelectionDialog
    ...
    def _make_progress_dialog(self, title: str, subtitle: str):
        from src.ui.dialogs.prof_progress_dialog import ProfProgressDialog
    ...
    def _show_keybindings(self) -> None:
        from src.ui.dialogs.keybindings_dialog import KeybindingsDialog

        KeybindingsDialog(self).exec()

    def _ensure_tutorial(self) -> "object":
        if getattr(self, "_tutorial", None) is None:
            from src.ui.tutorial import TutorialWalkthrough
    ...
    def maybe_show_first_run_tutorial(self) -> None:
        ...
        from src.utils.prefs import get_pref
    ...
    def _on_bulk_kpt_edit(self) -> None:
        if self._dataset_root is None:
            ...
            return
        from src.ui.dialogs.kpt_bulk_edit_dialog import KptBulkEditDialog
    ...
    def _on_json_edited(self, json_text: str) -> None:
        ...
        try:
            ...
            from src.core.annotation.models import (
                Annotation,
                BBox,
                ImageAnnotations,
                Keypoint,
