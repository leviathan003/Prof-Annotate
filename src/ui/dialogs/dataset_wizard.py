...
from src.config.constants import AUTOANNOTATE_HUMAN_WARNING, NUM_KEYPOINTS
...
class _DatasetWorker(QObject):
    ...
    def _run_auto_annotate(self, dest: Path) -> None:
        from src.config.constants import YOLO_IMAGE_EXTS
...
class _Page(QFrame):
    def __init__(self) -> None:
        ...
        from src.ui.dialogs._prof_layout import screen_aware_size
