"""
profannotate/ui/dialogs/splash_screen.py
...
from profannotate.config.constants import APP_NAME, APP_VERSION
from profannotate.ui.dialogs._prof_layout import _screen_metrics
from profannotate.ui.prof_annotate import (
    PROF_PORTRAIT,
    PROF_PORTRAIT_SMALL,
    PROF_PORTRAIT_TINY,
    SPLASH_LINES,
