...
![App Screenshot](docs/images/tutorial-btn.png)


After clicking, the following window will start up commencing the tutorial. 

![App Screenshot](docs/images/tutorial-start.png)

## Tutorial

1. Click on the Begin the Tour button to start the tutorial.
![App Screenshot](docs/images/tutorial-start-btn.png)
...
![App Screenshot](docs/images/create-new-dataset.png)
...
3. The File Explorer: 
![App Screenshot](docs/images/file-explorer.png)
...
4. The Stats Panel: 
![App Screenshot](docs/images/stats-panel.png)
...
![App Screenshot](docs/images/modality-toggles.png)
...
![App Screenshot](docs/images/data-yaml.png)
...
![App Screenshot](docs/images/keybindings.png)
...
10. Conclusion: 
![App Screenshot](docs/images/tutorial-conclusion.png)
