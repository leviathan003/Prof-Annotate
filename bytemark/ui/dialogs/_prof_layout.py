...
from bytemark.ui.prof_annotate import (
    PROF_PORTRAIT,
    PROF_PORTRAIT_SMALL,
    PROF_PORTRAIT_TINY,
)
from bytemark.utils.ui_scaling import portrait_column_width, prof_portrait_tier
...
def _tune_prof_column(
    ...
    from bytemark.utils.ui_scaling import ScreenInfo
