...
class StatusBar(QStatusBar):
    def __init__(self, parent=None) -> None:
        ...
        self._git_info = self._add_field("Last commit")

    def _add_field(self, key: str) -> QLabel:
        key_lbl = QLabel(f" {key}:")
        key_lbl.setObjectName("status_field")
        val_lbl = QLabel("—")
        val_lbl.setObjectName("status_field_value")
        sep = QLabel("│")
        sep.setObjectName("status_field")
        self.addPermanentWidget(key_lbl)
        self.addPermanentWidget(val_lbl)
